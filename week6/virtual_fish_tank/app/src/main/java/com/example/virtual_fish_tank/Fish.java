...
public class Fish {
    ...
    // FISH ARTWORK OBJECT HAS A CURRENT POSITION THAT CAN BE ACCESSED PUBLICLY
    public int x;
    public int y;
    ...
    private void swim () {
        ...
        // TASK 3: FIND ANOTHER PLACE TO EXPLORE IN THE TOP HALF OF THE TANK
    ...
    private void findFood () {
        ...
        // TASK 2: DETERMINE IF FOOD IS FOUND
